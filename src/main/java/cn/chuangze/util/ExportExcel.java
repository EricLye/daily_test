...
public class ExportExcel {
	...
	public static void main(String[] args) throws Exception {
		...
		int columnNumber = 4;
		//	列宽度
		int[] columnWidth = { 25, 30, 30, 30 };	
		//	表头
		String[] columnName = { "单号", "申请时间", "申请部门","申请部门2"  };
		//	内容
		String[][] dataList = { { "001", "2015-01-01", "IT", "测试"  },

				{ "002", "2015-01-02", "市场部", "测试"  }, { "003", "2015-01-03", "测试", "测试"  } };
		/***
	...
	public void ExportWithResponse(String sheetName, String titleName,
			...
			String[] columnName, String[][] dataList, String filePath,
...
//				zidonghuanhang2.setBorderTop(HSSFCellStyle.BORDER_THIN);
	...
	public void ExportNoResponse(String sheetName, String titleName,
			...
			String[] columnName, String[][] dataList, String filePath) throws Exception {
...
//				zidonghuanhang2.setBorderTop(HSSFCellStyle.BORDER_THIN);
	...
	public HSSFWorkbook ExportExcelFile(String sheetName, String titleName,
